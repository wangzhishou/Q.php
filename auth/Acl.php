 ...
 *
 * <p>Acl performs authorization checks for the specified resource and action. It checks against the rules defined in acl.conf.php.</p>
 ...
 * </code>
 *
 * <p>You have to assign the rules to Acl in bootstrap.</p>
 * <code>
 * # set rules
 * Q::acl()->rules = $acl;
 *
...
class Acl {
	 ...
	 * Q::acl()->isAllowed('member', 'BlogController', 'post' );
	 *
	 * //Check if member is allowed for BlogController
	 * Q::acl()->isAllowed('member', 'BlogController');
	 * </code>
	 *
	 * @param string $role Role of a user, usually retrieve from user's login session
	 * @param string $resource Resource name (use Controller class name)
	 ...
	 * Q::acl()->isDenied('member', 'BlogController', 'post' );
	 *
	 * //Check if member is denied from BlogController
	 * Q::acl()->isDenied('member', 'BlogController');
	 * </code>
	 *
	 * @param string $role Role of a user, usually retrieve from user's login session
	 * @param string $resource Resource name (use Controller class name)
