...
class RbAcl extends Acl{
     ...
     * Q::acl()->isAllowed(array('member','admin'), 'BlogController', 'post' );
     *
     * //Check if members are allowed for BlogController
     * Q::acl()->isAllowed(array('anonymous','member'), 'BlogController');
     * </code>
     *
     ...
     * Q::acl()->isDenied(array('member','admin'), 'BlogController', 'post' );
     *
     * //Check if members are denied from BlogController
     * Q::acl()->isDenied(array('anonymous','member'), 'BlogController');
     * </code>
     *
