...
/**
 * FileCache provides file based caching methods.
 *
 * @author Leng Sheng Hong <darkredz@gmail.com>
 * @version $Id: FileCache.php 1000 2009-08-27 19:36:10
 * @package .cache
 * @since 1.1
 */
    ...
    public function __construct($path='') {
        if ( $path=='' ) {
            if(isset(Q::conf()->CACHE_PATH))
                $this->_directory = Q::conf()->CACHE_PATH;
            else
                $this->_directory = Q::conf()->SITE_PATH . Q::conf()->PROTECTED_FOLDER . 'cache/';
        }else{
