 ...
 * </code>
 * @author Leng Sheng Hong <darkredz@gmail.com>
 * @version $Id: RestClient.php 1000 2009-07-7 18:27:22
 * @package .helper
 * @since 1.0
 */
class RestClient {
    ...
    //for sending Accept header, this is to be used with requests to REST server which is built with  Framework
     ...
     * <code>
     * $client = new RestClient('http://somewebsite.com/api/rest');
     ...
     *
     * <p>If you are implementing your own RESTful api, you can handle authentication with DigestAuth::http_auth()
     ...
     * RestClient provides a list of common used format to be used in your code.</p>
     * Example to retrieve result in JSON:
     * <code>
     * $client = new RestClient;
     * $client->connect_to("http://twitter.com/direct_messages")
     *        ->auth('username', 'password', true)
     *        ->accept(RestClient::JSON)
     *        ->get();
     * </code>
     * @param string $type
     * @return mixed
     ...
     *        ->auth('username', 'password', true)
     *        ->setContentType(RestClient::JSON)
     *        ->post();
     * </code>
     * @param string $type
     * @return mixed
