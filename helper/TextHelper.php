 ...
 *
 * @version $Id: TextHelper.php 1000 2009-08-4 11:17:22
 * @package .helper
 * @since 1.1
 */
class TextHelper {
	 ...
	 *        	CSS class name of the link tag
	 * @param string $target
	 *        	Target: _self, _blank, _parent, etc.
	 * @param bool $convertEmail
	 *        	Convert email address into links. Default true.
	 * @param string $emailHide
	 *        	Change this if you want to hide the email. eg. leng[AT]php.com, value = '[AT]'
	 * @return string
	 */
	 ...
	 *        	Escape type: html, htmlall, url
	 * @param string $charSet
	 *        	Character set, default ISO-8859-1
	 * @return string
	 */
	 ...
	 * @param array $censorWords
	 *        	List of words to be censored
	 * @param string $replacement
	 *        	Optional replacement string for the censored word
	 * @param bool $word
	 *        	True to be an exact word, False to censor within word 'Youprofanity'
	 * @return string
	 */
	 ...
	 *        	String input
	 * @param string $phrase
	 *        	The phrase to be highlighted
	 * @param string $tagOpen
	 *        	HTML tag added right before the word
	 * @param string $tagClose
	 *        	HTML tag added right after the word
	 * @return string
	 */
	 ...
	 *        	The character encoding. eg. utf8
	 * @return string
	 */
