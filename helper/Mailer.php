...
/**
 * Mailer class, for sending e-mails
 *
 * @author Milos Kovacki <kovacki@gmail.com>
...
class Mailer {
	...
	public function send() {
		...
		$boundryMixed = 'PHP-mixed-' . $random_hash;		// Boundry for mixed content type (ie. Text and File Attachments)
		$boundryAlt   = 'PHP-alt-' . $random_hash;		// Boundry for Alternative mail types (ie. plain and html)
