<?php
/**
 * ManagePgSqlDb class file.
 *
 * @author Richard Myers <richard.myers@hotmail.co.uk>
 * @link http://www.php.com/
 * @license http://www.php.com/license
 * @package .db.manage.adapters
 * @since 1.3
 */
Q::loadCore('db/manage/ManageDb');

class ManagePgSqlDb extends ManageDb {


	/**
	 * A mapping of ManageDb generic datatypes to RDBMS native datatypes for columns
	...
	protected $colTypeMapping = array (
		ManageDb::COL_TYPE_BOOL		=> 'BOOLEAN',
    	ManageDb::COL_TYPE_SMALLINT	=> 'SMALLINT',
    	ManageDb::COL_TYPE_INT		=> 'INTEGER',
    	ManageDb::COL_TYPE_BIGINT	=> 'BIGINT',
    	ManageDb::COL_TYPE_DECIMAL	=> 'NUMERIC',
    	ManageDb::COL_TYPE_FLOAT		=> 'DOUBLE PRECISION',
    	ManageDb::COL_TYPE_CHAR		=> 'CHAR',
    	ManageDb::COL_TYPE_VARCHAR	=> 'VARCHAR',
    	ManageDb::COL_TYPE_CLOB		=> 'TEXT',
    	ManageDb::COL_TYPE_DATE		=> 'DATE',
    	ManageDb::COL_TYPE_TIME		=> 'TIME',
    	ManageDb::COL_TYPE_TIMESTAMP	=> 'TIMESTAMP',
	);
