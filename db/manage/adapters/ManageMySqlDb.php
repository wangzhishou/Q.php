...
class ManageMySqlDb extends ManageDb {
	...
	protected $colTypeMapping = array (
    	...
    	ManageDb::COL_TYPE_DECIMAL	=> 'DECIMAL',
    	ManageDb::COL_TYPE_FLOAT		=> 'DOUBLE',
    	ManageDb::COL_TYPE_CHAR		=> 'CHAR',
    	ManageDb::COL_TYPE_VARCHAR	=> 'VARCHAR',
    	ManageDb::COL_TYPE_CLOB		=> 'LONGTEXT',
    	ManageDb::COL_TYPE_DATE		=> 'DATE',
    	ManageDb::COL_TYPE_TIME		=> 'TIME',
    	ManageDb::COL_TYPE_TIMESTAMP	=> 'DATETIME',
	);
