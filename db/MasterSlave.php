...
/**
 * MasterSlave is an ORM tool based on SqlMagic with Database Replication support.
 *
 ...
 *
 * <p>MasterSlave <b>DOES NOT</b> send SELECT statement to a random slave. Instead, it is based on calculation with both access time and Slave nodes.</p>
 *
...
Q::loadCore('db/SqlMagic');

class MasterSlave extends SqlMagic {
