...
class CliApp {
	...
	private function runController($controller, $action, $arguments) {
		$controllerFile = Q::conf()->SITE_PATH . Q::conf()->PROTECTED_FOLDER . "controller/{$controller}.php";

		if (file_exists($controllerFile)) {
			require_once Q::conf()->BASE_PATH ."controller/CliController.php";
