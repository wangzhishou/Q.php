...
/**
* CacheSession, manage session inside cache system instead of
* default php session system, extremely useful when we need extreme
* performance and combined with memcache
* Create your required cache system, pass the cache object to the CacheSession::installOnCache, example:
* <code>
* $cache = Q::cache('memcache');
* CacheSession::insallOnCache($cache, 'myPrefixForSessionID');
* $session = Q::session("mysite");
* </code>
...
class CacheSession
{
     ...
     * Session ID prefix
     */
	protected static $sessionPrefix = 'CS';
